          ...
          {cart.map((p) => (
            ...
            >
              <div className="flex items-center gap-4">
                <img src={p.image_mobile} alt={p.name} className="w-10 h-10 rounded object-cover" />
                <div>
                  <h2 className="font-Lora text-xs text-[var(--color-text)]">{p.name}</h2>
                  <p className="font-Josefin text-xs text-[var(--color-text-light)]">
